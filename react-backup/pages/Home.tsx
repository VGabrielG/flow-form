          ...
          {models.map((model: any) => (
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className={`absolute top-4 left-4 bg-${themeColor}-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider`}>
                  {model.material.split(' ')[0]}
                </div>
              </div>
              <div className="p-6">
